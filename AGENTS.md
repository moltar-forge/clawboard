...
Engineering reference for AI agents and contributors working in the Clawboard monorepo.
...
- Default database/user: `clawboard`
...
|----------|---------|---------|
| `DB_HOST`, `DB_PORT`, `DB_NAME`, `DB_USER`, `DB_PASSWORD` | PostgreSQL connection | `clawboard` / `5432` |
| `JWT_SECRET`, `JWT_EXPIRES_IN` | Authentication | — / `7d` |
| `CORS_ORIGIN` | Allowed CORS origin | `http://localhost:5173` |
| `BOOTSTRAP_OWNER_EMAIL`, `BOOTSTRAP_OWNER_PASSWORD` | First-run owner account | `clawboard@gmail.com` |
...
| `VITE_API_URL`, `VITE_APP_NAME` | Dashboard build-time config | `http://localhost:3000/api/v1` / `Clawboard` |
